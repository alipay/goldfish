...
import { UseStateHistoryReturn, useStateWithHistory } from 'react-use/esm/useStateWithHistory';
import { IHookStateSetAction } from 'react-use/esm/misc/hookState';
...
describe('useStateWithHistory', () => {
  ...
  it('should act like regular setState', async () => {
    ...
    act(() => {
      hook.result.current[0][1]((current: any) => (current ?? 0) + 111);
    });
    await timeout();
  ...
  it('should apply capacity change only with next state set', async () => {
  ...
  describe('history.back()', () => {
    it('should cause rerender', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should travel history back one step at a time if called without arguments', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should travel history back by arbitrary amount of elements passed as 1st argument', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should stop on first element if traveled to the left border', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
  ...
  describe('history.forward()', () => {
    ...
    it('should travel history forward one step at a time if called without arguments', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should travel history forward by arbitrary amount of elements passed as 1st argument', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should stop on last element if traveled to the right border', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
  ...
  describe('history.go()', () => {
    ...
    it('should go to arbitrary position passed as 1st element', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should count from the right if position is negative', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    ...
    it('should properly handle too big values', async () => {
      const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
  ...
  it('should pop elements to the right when setting state being not in the end of history', async () => {
    const hook = getHook(5, 5, [1, 2, 3, 4, 5]);
    act(() => {
      hook.result.current[0][2].back(2);
    });
