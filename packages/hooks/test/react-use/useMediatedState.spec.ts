...
import { useMediatedState, StateMediator, UseMediatedStateReturn } from 'react-use/esm/useMediatedState';
...
describe('useMediatedState', () => {
  ...
  it('should act like regular useState but with mediator call on each setState', async () => {
  ...
  it('mediator should receive setState argument as first argument', async () => {
    let val;
  ...
  it('if mediator expects 2 args, second should be a function setting the state', async () => {
