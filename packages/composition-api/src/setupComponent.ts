import { observable, IProps, state, ComponentInstance } from '@alipay/goldfish-reactive-connect';
...
import { AppStore, createComponent, ComponentStore } from '@alipay/goldfish';
